...
final public class TradeApi {
	 ...
	 *         trading.
	 * @throws Exception
	 *             with messages constants: EXCEPTION_INFO_NOT_SUCCESS,
	 ...
	 *            target price
	 * @param pauseMillis
	 *            - pause in milliseconds, may be used "in loop"
	 ...
	 * @param pairName
	 *            pair name
	 * @param reuseAgeMillis
	 *            - limit for reusing the data, contains in public and private
	 ...
	 * @throws Exception
	 *             with messages constants: EXCEPTION_MULTIPLE_FAILURE,
